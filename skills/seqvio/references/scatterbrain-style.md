...
```bash
seqvio-audio extract --component examples/compositions/seqvio-scatterbrain.tsx \
  --out output/seqvio-scatterbrain.manifest.json
seqvio-audio synthesize --manifest output/seqvio-scatterbrain.manifest.json \
  --outDir output/seqvio-scatterbrain-audio
node packages/renderer/dist/cli.js \
  --component examples/compositions/seqvio-scatterbrain.tsx \
  --audioManifest output/seqvio-scatterbrain-audio/audio-manifest.resolved.json \
  --output output/seqvio-scatterbrain.mp4
```
