...
| [`MANIM-INTEGRATION.md`](./MANIM-INTEGRATION.md)                                 | Optional Python Manim setup, adapter rendering, cache/manifests, and `ManimClip` timeline integration |
...
| [`../packages/manim-adapter/README.md`](../packages/manim-adapter/README.md)     | Experimental Python Manim adapter API and runtime boundary                                            |
...
| [`MANIM-INTEGRATION.md`](./MANIM-INTEGRATION.md)                                                               | Current external Python Manim render and Seqvio playback workflow                             |
