...
[![英文介绍预览](./docs/assets/videos/seqvio-overview-en.preview.gif)](./docs/assets/videos/seqvio-overview-en.mp4)

▶ [观看带旁白完整视频 (MP4)](./docs/assets/videos/seqvio-overview-en.mp4)
...
▶ [观看带旁白完整视频 (MP4)](./docs/assets/videos/seqvio-overview-zh.mp4) — GitHub 会移除指向仓库文件的 `<video>` 标签，请点击预览图或链接打开完整视频。
